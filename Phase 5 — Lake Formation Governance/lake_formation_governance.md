...
* Add Inline S3 Policy (Athena_S3_Access)
    ...
    JSON:
        ...
        "Resource": [
                     "arn:aws:s3:::retailflow-bucket-2026",
                     "arn:aws:s3:::retailflow-bucket-2026/*"
                    ]
        }
                    ]
...
2. Data Lake Permission Mapping
         ...
         Data Lake Resource     
    (retailflow_raw.customers)
           |
           |
    Has email column tagged as PII
           |
           |                      
    Lake Formation Evaluation         
           |______________________________________
           │                                     │
    Data Analyst Role                    Data Engineer Role
           │                                     │
    Evaluates Tag Expression         Evaluates Tag Expression
     (Confidential)                     (Confidential, PII)
           │                                     │
    Applies Column Filter                        │
   (Explicitly Hide Email)                       │
           |                                     |
    Athena Result Grid                   Athena Result Grid       
   [Email Column Omitted]              [Email Column Visible]     
